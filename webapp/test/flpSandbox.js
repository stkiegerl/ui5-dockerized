		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Dockerized",
									"targetURL": "#ui5dockerized-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5dockerized-display": {
								"semanticObject": "ui5dockerized",
								"action": "display",
								"description": "A Dockerized Fiori application.",
								"title": "UI5 Dockerized",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5dockerized",
									"url": sap.ui.require.toUrl("ui5dockerized")
								}
							}
						}
					}
